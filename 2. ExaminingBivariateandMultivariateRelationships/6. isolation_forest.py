...
outlier[['location','total_cases_mill','total_deaths_mill','scores']].\
...
ax.scatter3D(inlier.gdp_per_capita, inlier.aged_65_older, inlier.total_cases_mill, label="inliers", c="blue")
ax.scatter3D(outlier.gdp_per_capita, outlier.aged_65_older, outlier.total_cases_mill, label="outliers", c="red")
ax.legend()
plt.show()
